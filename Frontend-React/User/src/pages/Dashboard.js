...
export default function Dashboard() {
    ...
    return (
        <>
            <div className="outer mt-6 bg-gray-50 rounded-lg" style={{ margin: "5px" }}>
                ...
                <div className="wrapper" style={{ display: "flex" }}>
                    <div id="Main" style={{ flex: "0 10 18%", marginRight: "10px" }}
                        className={`${show ? 'translate-x-0 width-1/5' : '-translate-x-full width-0'} col-3 rounded-lg
                     ...
                     items-start h-full sm:w-64 bg-gray-200 flex-col m-4 `}>
                        ...
                        <div className="mt-6 flex flex-col justify-start items-center h-screen border-gray-200 border-b w-full ">
                            ...
                            <Link to="/dashboard/stat" className=" w-full text-black-600 hover:text-blue-500">
                            ...
                            <Link to="/dashboard/MyToken" className=" w-full text-black-600 hover:text-blue-500" >
                            <button className="flex jusitfy-start items-center w-full p-2 space-x-6 hover:bg-blue-500 focus:outline-none text-black focus:text-blue-400 rounded ">
                            ...
                            <Link to="/dashboard/Polls" className=" w-full text-black-600 hover:text-blue-500">
                    ...
                    <div
                        style={{ flex: "10 0 80%" }} className={`${show ? 'translate-x-0 width-4/5' : '-translate-x-20 width-full'} `} ><Outlet /></div>
                </div>
            </div>
